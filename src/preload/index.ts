...
import { CLOUD_IPC, type CloudAction, type CloudResult } from '../shared/cloud';
...
const api = {
  cloudAccount: (action: CloudAction): Promise<CloudResult> => ipcRenderer.invoke(CLOUD_IPC, action),
